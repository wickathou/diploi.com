...
### **1. Scope**  
**1.1.** These Terms of Service ("**Terms**") define your use of the services (the "**Services**") provided by **Diploi Ltd** (Business ID: 3419551-2, VAT: FI34195512), a Finnish limited liability company with its registered office at **Malminkatu 30, 00100 Helsinki, Finland** ("**Diploi**," "**we**," or "**us**").  
...
- **(i)** You have the legal authority to bind that entity to these Terms;  
- **(ii)** You have read and understood these Terms; and  
- **(iii)** You accept these Terms on behalf of the entity.  
...
**"Affiliate"** means an entity that directly or indirectly controls, is controlled by, or shares common control with a party (with "control" defined as >50% ownership of voting rights).  
...
**Diploi provides support** to the Users who initiate a request for support. Contact methods supported by Diploi include Discord for issues that do not require private information disclosures and via email to support@diploi.com for issues that require disclosure of private information.  
...
**10.2** Prices include VAT (FI34195512) and applicable taxes unless stated otherwise.  
...
### **11. Payment & Credits**  
**11.1** Services are prepaid via **non-refundable, non-transferable Credits** purchased through your Account. Invoices are available for download in the Control Panel.  

**11.2** Maintain a **positive Credit balance** to avoid Service suspension. Failure to replenish Credits within **14 days of suspension** will result in **Account termination and deletion of Customer Data**. Fees accrue during suspension until termination.  
...
- **(i)** Temporarily suspending your Account;  
- **(ii)** Terminating the Agreement for material or repeated violations;  
- **(iii)** Removing or restricting access to Illegal Content without prior notice if legally mandated.  
...
- **Intellectual Property Violations:** Copying, redistributing, or reverse-engineering the Services without authorization.  
- **System Abuse:** Overloading, disrupting, or mining data from Diploi’s infrastructure.  
- **Fraud & Spam:** Transmitting unauthorized ads, malware, or mass communications.  
- **Impersonation:** Creating accounts for others without consent.  
- **Criminal Activity:** Engaging in illegal acts or violating third-party rights (e.g., privacy, trade secrets).

***

### **15. Liability & Indemnification**  
**15.1** **Diploi’s IP Infringement Defense:**  
If the Services infringe a third party’s intellectual property rights, Diploi will:  
- Defend you against claims and cover court-awarded damages, provided you:  
  - Notify us in writing within **30 days** of the claim;  
  - Grant us sole control over the defense;  
  - Provide reasonable assistance.  

**15.2** **Remedies for Infringement:**  
Diploi may, at its option:  
- Modify the Services to resolve the issue;  
- Procure a license for your continued use; or  
- Terminate the Agreement and refund prorated fees.  

**15.3** **Exclusions:**
Diploi is not liable for claims arising from:  
- Modifications by you, Users, or third parties;  
- Use with non-Diploi products;  
- Failure to use the latest Service version;  
- Activities unrelated to the Services.  
...
- Damages, liabilities, and legal costs incurred by Diploi;  
- Settlements approved by you.  
...
- Limit access to personnel needing it for the Agreement;  
- Protect confidentiality using reasonable measures.  
...
- Fees paid in the prior 6 months; or  
- €10,000.  
...
**21.1** You agree to comply with **EU, U.S., and Finnish export/sanctions laws**. Prohibit use in embargoed regions (e.g., Crimea, North Korea).  
...
- **Materially breaches** the Agreement and fails to remedy it within **10 business days** of written notice;  
- Becomes **insolvent**, enters liquidation, or fails to pay debts.  
...
- Diploi may transfer rights to **Affiliates** or during mergers/acquisitions;  
- Diploi may use subcontractors but remains responsible for their performance.  
...
- Sent via **registered mail** to Diploi Ltd, Malminkatu 30, 00100 Helsinki; or  
- Emailed to support@diploi.com.
